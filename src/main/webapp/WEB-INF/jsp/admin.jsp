        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath }/department/list.action">
                            <i class="fa fa-edit fa-fw"></i> 人员管理
                        </a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath }/salary/list.action">
                            <i class="fa fa-dashboard fa-fw"></i> 药品管理
                        </a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath }/people/list.action" class="active">
...
<script type="text/javascript">
    ...
    function edit(id) {
        $.ajax({
            type: "get",
            url: "<%=basePath%>employee/getById.action",
            data: {"id": id},
    ...
    // 执行修改药品操作
    function update() {
        $.post("<%=basePath%>employee/update.action", $("#edit_form").serialize(), function (data) {
            if (data == "OK") {
                alert("信息更新成功！");
                window.location.reload();
            } else {
