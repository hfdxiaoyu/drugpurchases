...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation"
        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="#"><font size=6 color="lightsalmon"><B>药品采购系统</B></font></a>
       </div>
        ...
        <ul class="nav navbar-top-links navbar-right">
        	<li class="dropdown">
        		<form class="form-inline my-2 my-lg-0">
					<input class="form-control mr-sm-2" type="search" placeholder="搜索内容..." aria-label="Search">
  ...
  <path fill-rule="evenodd" d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                ...
                <ul class="dropdown-menu dropdown-user">
                    <li><a href="#"><i class="fa fa-user fa-fw"><svg class="bi bi-person-square" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <path fill-rule="evenodd" d="M2 15v-1c0-1 1-4 6-4s6 3 6 4v1H2zm6-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                    ...
                    <li><a href="#"><i class="fa fa-gear fa-fw"><svg class="bi bi-gear-wide" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <path fill-rule="evenodd" d="M2 13.5A1.5 1.5 0 0 1 .5 12V4A1.5 1.5 0 0 1 2 2.5h7A1.5 1.5 0 0 1 10.5 4v1.5a.5.5 0 0 1-1 0V4a.5.5 0 0 0-.5-.5H2a.5.5 0 0 0-.5.5v8a.5.5 0 0 0 .5.5h7a.5.5 0 0 0 .5-.5v-1.5a.5.5 0 0 1 1 0V12A1.5 1.5 0 0 1 9 13.5H2z"/>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="drug.html">
                            <i class="fa fa-edit fa-fw"></i> 药品管理
                        </a>
                    </li>
                    <li>
                        <a href="buy.html">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><b><font size="6" color="skyblue">采购管理</font></b></h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
            <!-- 左侧显示列表部分 end-->
